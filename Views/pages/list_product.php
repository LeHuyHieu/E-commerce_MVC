...
<div class="content-wraper pt-60 pb-60 pt-sm-30">
    <div class="container">
        <div class="row">
            <div class="col-lg-9 order-1 order-lg-2" id="dataListProduct">
                <!-- Begin Li's Banner Area -->
                <div class="single-banner shop-page-banner">
                    <a href="#">
                        <img loading="lazy" class="lazyload" src="./public/images/bg-banner/2.jpg" alt="Li's Static Banner">
                    </a>
                </div>
                ...
                <?php }else { ?>
                    <h3 class="not-found-product">No suitable products were found</h3>
                <?php } ?>
