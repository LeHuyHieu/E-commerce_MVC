                            ...
                            <table class="table align-middle mb-3" id="dataTableAttrProduct">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div><h6 class="mb-1 font-14"><?php echo $color['name'];?></h6></div>
                                        </td>
                                        <td>
                                            <div><h6 class="mb-1 font-14"><?php echo $color['value'];?></h6></div>
                                        </td>
                                        <td>
                            ...
                            <table class="table align-middle mb-3" id="dataTableAttrProduct2">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div><h6 class="mb-1 font-14"><?php echo $size['name'];?></h6></div>
                                        </td>
                                        <td>
                                            <div class="d-flex order-actions">
