...
if ($condition) {
    if (isset($_SESSION['staff']) && $_SESSION['staff']['role'] === 10) {
        ...
        $user_count = $tb_users->getAllUserNotIsVisible()->rowCount();
        $count = $pages->findPage($user_count, $limit);
        $current_page = (isset($_GET['page']) && !empty($_GET['page'])) ? $_GET['page'] : 1;
        $users = $tb_users->getAllUserNotIsVisiblePagination($start, $limit)->fetchAll();
?>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-lg-flex align-items-center mb-4 gap-3">
                            ...
                            <a href="index.php?action=users" class="btn btn-primary ms-auto">List Visible</a>
                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex order-actions">
                                                        <a href="index.php?action=users&process=is-visible&id=<?php echo $user['id'];?>" class="me-3"><i class='bx bx-show-alt'></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                        <?php }
