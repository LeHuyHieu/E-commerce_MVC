            ...
            <div class="col-xl-7 mx-auto">
                ...
                <div class="card border-top border-0 border-4 border-primary">
                    <div class="card-body p-5">
                        <form class="row g-3" action="index.php?action=categories&process=update" method="post" enctype="multipart/form-data">
                            <input type="hidden" name="id" value="<?php echo $id;?>">
                            <div class="col-md-6">
                                <label for="inputCategoryName" class="form-label">Category Name</label>
                                <input type="text" class="form-control" value="<?php echo $category['name'];?>" name="name" id="inputCategoryName" placeholder="Category name" required>
                            </div>
                            <div class="col-md-6">
                                ...
                                <select class="single-select" id="selectParentId" name="parent_id" required>
                                    ...
                                    <?php echo $tb_categories->selectCategories($categories, $category['parent_id']);?>
                                </select>
                            </div>
                            <div class="col-md-12">
                                <label for="bannerCategory" class="form-label">Banner Image</label>
                                <input type="file" class="form-control mb-3" name="banner_image" value="<?php echo $category['banner_image'];?>" onchange="preview()" id="bannerCategory">
                                <img src="<?php echo isset($category['banner_image']) && $category['banner_image']  != '' ? 'uploads/categories/'.$category['banner_image'] : 'assets/images/no_image.jpg';?>" id="showImage" class="img-fluid rounded" width="100px" alt="Show image"/>
                            </div>
                            <div class="col-12">
