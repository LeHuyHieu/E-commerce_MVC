        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xl-12 mx-auto">
                    ...
                    <form action="index.php?action=staff&process=update" method="POST">
                                ...
                                <div class="row g-3">
                                    <div class="col-lg-5 col-md-5 col-sm-12 col-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="name" class="form-control" id="name" value="<?php echo $staff['name']; ?>" placeholder="Name staff" autofocus>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                                        <div class="form-group mb-3">
                                            <label for="emailStaff" class="form-label">Email</label>
                                            <input type="email" name="email" class="form-control" id="emailStaff" value="<?php echo $staff['email']; ?>" placeholder="Email staff">
                                        </div>
                                    </div>
                        ...
                        <div class="text-end">
                            <button type="submit" name="submit" class="btn btn-primary"><i class="bx bx-plus-circle"></i> Update staff</button>
                        </div>
                    </form>
                </div>
            </div>
