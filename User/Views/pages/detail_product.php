            ...
            <div class="col-lg-5 col-md-6">
                ...
                <div class="product-details-left">
                    <div class="product-details-images slider-navigation-1">
                        ...
                        ?>
                            <div class="lg-image">
                                <img loading="lazy" src="./Public/images/uploads/<?php echo $image_item['image_product'];?>" alt="product image">
                            </div>
                        <?php }else { ?> 
                            <div class="lg-image">
                                <img loading="lazy" src="./Public/images/uploads/<?php echo $list_color[0]['image_product'];?>" class="show-image-product<?php echo $get_detail_product['id'];?>" alt="product image">
                            </div>
                        <?php } } ?>
                        <?php foreach ($list_images as $key => $image_item) { ?>
                            <div class="lg-image">
                                <img loading="lazy" src="./Public/images/uploads/<?php echo $image_item['image'];?>" alt="product image">
                            </div>
                        <?php } ?>
                    </div>
                    <div class="product-details-thumbs slider-thumbs-1">
                        <?php foreach ($list_color as $key => $image_item) { ?>
                            <div class="sm-image"><img loading="lazy" src="./Public/images/uploads/<?php echo $image_item['image_product'];?>" alt="product image thumb"></div>
                        <?php } ?>
                        <?php foreach ($list_images as $key => $image_item) { ?>
                            <div class="sm-image"><img loading="lazy" src="./Public/images/uploads/<?php echo $image_item['image'];?>" alt="product image thumb"></div>
                        <?php } ?>
                    </div>
                </div>
                <!--// Product Details Left -->
                ...
                <div class="product-reviews">
                    <div class="product-details-comment-block">
                        <div class="list_comment">
                            <?php
                            $comments = $tb_comment->getListComments($id)->fetchAll();
                            if (count($comments) > 0) {
                                foreach ($comments as $comment) {
                                    ...
                                    <?php
                                    $reply_comment = $tb_comment->getListReplyComments();
                                ...
                                ?>
                                <div class="comment-author-infos pt-25">
                                    <span>There are no comment yet</span>
                                </div>
                            <?php } ?>
                        </div>
                        <?php if (!isset($_SESSION['user'])) { ?>
                        ...
                        <?php } else { ?>
                                                            ...
                                                            <div class="feedback">
                                                                ...
                                                                <form id="formReplyComment" method="post" action="index.php?action=comment&handle=reply_comment&product_id=<?php echo $id;?>">
                                                                    ...
                                                                    <div class="feedback-input">
                                                                        <div class="feedback-btn pb-15">
                                                                            <a href="#" class="close" data-dismiss="modal" aria-label="Close">Close</a>
                                                                            <button type="submit" name="send_reply_comment" data-dismiss="modal" aria-label="Close" style="border: none;background: transparent;"><a>Submit</a></button>
                                                                        </div>
                                                                    </div>
                                                                </form>
                                                            </div>
                            ...
                            <!-- Quick View | Modal Area End Here -->
                            <div class="review-btn">
                                <a class="review-links" href="#" data-toggle="modal" data-target="#mymodal">Write Your Comment!</a>
                            </div>
                            <!-- Begin Quick View | Modal Area -->
                            <div class="modal fade modal-wrapper" id="mymodal">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            <h3 class="review-page-title">Write Your Comment</h3>
                                            <div class="modal-inner-area row">
                                                <div class="col-lg-12">
                                                    <div class="li-review-content">
                                                        <!-- Begin Feedback Area -->
                                            ...
                                            <div class="col-lg-5 col-md-6 col-sm-6">
                                                ...
                                                <div class="product-details-left">
                                                    <div class="product-details-images slider-navigation-1">
                                                        ...
                                                        <?php }else { ?> 
                                                            <div class="lg-image">
                                                                <img loading="lazy" src="./Public/images/uploads/<?php echo $list_color[0]['image_product'];?>" class="lazyload" class="show-image-product<?php echo $item['id'];?>" alt="product image">
                                                            </div>
                                                        <?php } } ?>
                                                        <?php foreach ($list_color as $key => $image_item) { ?>
                                                            <div class="lg-image">
                                                                    ...
                                                                    ?>
                                                                        <span class="color-product-image">
                                                                            <img loading="lazy" width="50px" 
                                                                                ...
                                                                                class="change-image-product lazyload <?php echo ($key == 0) ? 'product-active active' : '';?>" 
                                                                            alt="">
                                                                        </span>
                                                                    <?php } else { ?>
                                                                        <span class="color-product-image">
